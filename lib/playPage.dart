...
class MusicforTry extends StatefulWidget {
  const MusicforTry({super.key});

  @override
  State<MusicforTry> createState() => _MusicforTryState();
}

class _MusicforTryState extends State<MusicforTry> {
  ...
  void handleplaypause() async {
    print("player.state 1 === ${player.state}");
    if (player.state == PlayerState.playing) {
      await player.pause();
    } else {
      player.play(AssetSource(songs[i]));
      await player.resume();
    }
    print("player.state 2 === ${player.state}");
    setState(() {});
  }
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: InkWell(
                        ...
                        child: Padding(
                          padding: (player.state == PlayerState.playing)
